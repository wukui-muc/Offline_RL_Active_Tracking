...
def change(DIR,video,image):
    if os.path.isfile(os.path.join(Target_Dir,'images_v1',video,image)) and os.path.isfile(os.path.join(Target_Dir,'panomasks',video,image.split('.')[0]+'.png')):
        return
    ...
    if not os.path.exists(os.path.join(Target_Dir,'images_v1',video)):
        os.makedirs(os.path.join(Target_Dir,'images_v1',video))
    if not os.path.exists(os.path.join(Target_Dir,'panomasks',video)):
        os.makedirs(os.path.join(Target_Dir,'panomasks',video))

    img.save(os.path.join(Target_Dir,'images_v1',video,image))
